...
extension GameVC {
    ...
    func spawnEnemy() {
        ...
        tmpNode.scale = SCNVector3Make(0.1, 0.1, 0.1)
    ...
    func spawnIceCream() {
        ...
        repeat {
            iceCreamPos.x = Float.random(in: ((self.gameBoard.boundingBox.min.x + 0.2) ..< (self.gameBoard.boundingBox.max.x - 0.2)))
            iceCreamPos.y = Float.random(in: ((self.gameBoard.boundingBox.min.y + 0.2) ..< (self.gameBoard.boundingBox.max.y - 0.2)))
            iceCreamPos.z = 0.0
        } while(iceCreamPos.distance(vector: self.roboyNode.position) < 1.0)
        ...
        self.iceCreamNode.scale = SCNVector3Make(0.03, 0.03, 0.03)
        
        self.iceCreamNode.position = iceCreamPos
        self.iceCreamNode.position.y += 0.2
